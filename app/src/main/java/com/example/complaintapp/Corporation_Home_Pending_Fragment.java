 ...
 */
public class Corporation_Home_Pending_Fragment extends Fragment {

    View Pending_Complaints_View;
    RecyclerView vCorporation_Home_Pending_Recycler_View;
    ...
    public Corporation_Home_Pending_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vCorporation_Home_Pending_Recycler_View.setLayoutManager(linearLayoutManager);
        vCorporation_Home_Pending_Recycler_View.setAdapter(complaint_adapter);
        vCorporation_Home_Pending_Recycler_View.setHasFixedSize(true);
